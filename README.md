...
![tere](https://repo.x-cmd.io/tere.svg)
...
Total: **4,360** lines of code across **19** files in the top 5 languages.
...
- **Upstream**: <https://github.com/mgunyho/tere>
- **License**: EUPL-1.2
...
- **Stars**: 1,799 · **Forks**: 38 · **Open issues**: 48 · **Contributors**: 16

## Totals (cumulative)

- **Releases**: 10 · **Merged PRs**: 41 · **Open PRs**: 4 · **Closed issues**: 36 · **Open issues**: 12 · **Commits**: 1362
...
Reported by **18** distros on [repology.org](https://repology.org/project/tere). **16** are ✅ on the latest upstream release, **1** are ⚠️ on an older version.
...
_Snapshot: `data/card/260911.yml` · 2026-09-11T20:12:47Z._
